...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=unchecked]:bg-custom-black-700 data-[state=checked]:bg-custom-orange-900",
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "bg-custom-white-900 pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform",
